...
public final class PartitionByString extends PartitionFunction {
    ...
    public Object evaluationInternal(Map<? extends Object, ? extends Object> parameters) {
        ...
        if (arg == UNEVALUATABLE) throw new IllegalArgumentException("argument is UNEVALUATABLE");
    ...
    public FunctionExpression constructFunction(List<Expression> arguments) {
        if (arguments == null || arguments.size() != 1)
            throw new IllegalArgumentException("function "
                                               ...
                                               + arguments);
        PartitionByString partitionFunc = new PartitionByString(functionName, arguments);
