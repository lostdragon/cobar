 ...
 */
public class DMLDeleteParserTest extends AbstractSyntaxTest {
    public void testDelete1() throws SQLSyntaxErrorException {
        ...
        DMLDeleteParser parser = new DMLDeleteParser(lexer, new SQLExprParser(lexer));
        ...
        parser = new DMLDeleteParser(lexer, new SQLExprParser(lexer));
