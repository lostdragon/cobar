 ...
 */
public class DMLUpdateParserTest extends AbstractSyntaxTest {
    /**
    ...
    public void testUpdate() throws SQLSyntaxErrorException {
        ...
        DMLUpdateParser parser = new DMLUpdateParser(lexer, new SQLExprParser(lexer));
        ...
        parser = new DMLUpdateParser(lexer, new SQLExprParser(lexer));
