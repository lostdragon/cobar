 ...
 */
public class SQLExprParserTest extends AbstractSyntaxTest {
    ...
    public void testExpr1() throws Exception {
        ...
        lexer.nextToken();
        parser = new SQLExprParser(lexer);
        ...
        expr = parser.expression();
        output = output2MySQL(expr, sql);
        Assert.assertEquals("(N'\"abc\"abc\\'s' + 11.23 / id3) * (1E+2 - a OR b) % x'abc' AND (SELECT b'1001' ^ b'0000')",
                            output);
        Assert.assertEquals(LogicalAndExpression.class, expr.getClass());
        bex = (BinaryOperatorExpression) ((LogicalAndExpression) expr).getLeftOprand();
        ...
        Assert.assertEquals(ArithmeticDivideExpression.class, bex.getClass());
        Assert.assertEquals(DMLSelectStatement.class, ((LogicalAndExpression) expr).getRightOprand().getClass());
        ...
        expr = parser.expression();
        output = output2MySQL(expr, sql);
        Assert.assertEquals("NOT ! ~ `select` IN (1, CURDATE(), `current_date`) LIKE `all` DIV a BETWEEN (c AND d) AND d | e",
                            output);
        ...
        expr = parser.expression();
        output = output2MySQL(expr, sql);
        Assert.assertEquals("BINARY CASE ~ a OR b AND c ^ d XOR e WHEN 2 > ANY (SELECT a) THEN 3 ELSE 4 END IS NOT NULL = a",
                            output);
        ...
        bex = (BinaryOperatorExpression) cwex.getComparee();
        Assert.assertEquals(BitInvertExpression.class, bex.getLeftOprand().getClass());
        Assert.assertEquals(LogicalXORExpression.class, bex.getRightOprand().getClass());
        ...
        Assert.assertEquals(BitXORExpression.class, bex.getRightOprand().getClass());
        ...
        expr = parser.expression();
        output = output2MySQL(expr, sql);
        Assert.assertEquals("! INTERVAL(a, b) <=> a >> b COLLATE x / ? + a != @@1 OR @var SOUNDS LIKE - (a - b) % - (d OR e)",
                            output);
        Assert.assertEquals(LogicalOrExpression.class, expr.getClass());
        bex = (BinaryOperatorExpression) expr;
        Assert.assertEquals(ComparisionNotEqualsExpression.class, bex.getLeftOprand().getClass());
        Assert.assertEquals(SoundsLikeExpression.class, bex.getRightOprand().getClass());
        bex = (BinaryOperatorExpression) bex.getLeftOprand();
        ...
        bex = (BinaryOperatorExpression) ((BinaryOperatorExpression) expr).getRightOprand();
    ...
    public void testAssignment() throws Exception {
        String sql = "a /*dd*/:=b:=c";
        SQLExprParser parser = new SQLExprParser(new SQLLexer(sql));
        Expression expr = parser.expression();
        String output = output2MySQL(expr, sql);
        ...
        sql = "c=@var:=1";
        parser = new SQLExprParser(new SQLLexer(sql));
        expr = parser.expression();
        output = output2MySQL(expr, sql);
        ...
        Assert.assertEquals(LogicalAndExpression.class, lor.getRightOprand().getClass());
        lor = (LogicalOrExpression) ass.getRightOprand();
        Assert.assertEquals(LiteralBitField.class, lor.getLeftOprand().getClass());
        Assert.assertEquals(BitAndExpression.class, lor.getRightOprand().getClass());
        ...
        Assert.assertEquals(AssignmentExpression.class, lor.getLeftOprand().getClass());
        Assert.assertEquals(LogicalAndExpression.class, lor.getRightOprand().getClass());
        LogicalAndExpression land = (LogicalAndExpression) lor.getRightOprand();
        Assert.assertEquals(Identifier.class, land.getLeftOprand().getClass());
        Assert.assertEquals(BitAndExpression.class, land.getRightOprand().getClass());
        BitAndExpression band = (BitAndExpression) land.getRightOprand();
    ...
    public void testLogical() throws Exception {
        ...
        Assert.assertEquals(LogicalOrExpression.class, or.getLeftOprand().getClass());
        or = (LogicalOrExpression) or.getLeftOprand();
        Assert.assertEquals("b", ((Identifier) or.getRightOprand()).getIdText());
        ...
        Assert.assertEquals(LogicalAndExpression.class, and.getLeftOprand().getClass());
        and = (LogicalAndExpression) and.getLeftOprand();
        Assert.assertEquals("b", ((Identifier) and.getRightOprand()).getIdText());
    ...
    public void testComparision() throws Exception {
        ...
        expr = parser.expression();
        output = output2MySQL(expr, sql);
        Assert.assertEquals("a IS NOT NULL IS NOT FALSE IS NOT TRUE IS NOT UNKNOWN IS NULL IS FALSE IS TRUE IS UNKNOWN",
                            output);
    ...
    public void testAnyAll() throws Exception {
        ...
        expr = parser.expression();
        output = output2MySQL(expr, sql);
        Assert.assertEquals("1 >= ANY (SELECT id FROM t1 LIMIT 0, 1) > ALL (SELECT tb1.id FROM tb1 AS T1, tb2 AS T2 WHERE t1.id = t2.id LIMIT 0, 1)",
                            output);
    ...
    public void testStartedFromIdentifier() throws Exception {
        ...
        expr = parser.expression();
        output = output2MySQL(expr, sql);
        Assert.assertEquals("GROUP_CONCAT(DISTINCT expr1, expr2, expr3 ORDER BY col_name1 DESC, col_name2 SEPARATOR  )",
                            output);
