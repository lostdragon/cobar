...
import static com.alibaba.cobar.parser.recognizer.Token.EOF;
import static com.alibaba.cobar.parser.recognizer.Token.IDENTIFIER;
import static com.alibaba.cobar.parser.recognizer.Token.KW_AND;
import static com.alibaba.cobar.parser.recognizer.Token.KW_AS;
import static com.alibaba.cobar.parser.recognizer.Token.KW_ASC;
import static com.alibaba.cobar.parser.recognizer.Token.KW_BY;
import static com.alibaba.cobar.parser.recognizer.Token.KW_COLLATE;
import static com.alibaba.cobar.parser.recognizer.Token.KW_DESC;
import static com.alibaba.cobar.parser.recognizer.Token.KW_DISTINCT;
import static com.alibaba.cobar.parser.recognizer.Token.KW_FROM;
import static com.alibaba.cobar.parser.recognizer.Token.KW_IN;
import static com.alibaba.cobar.parser.recognizer.Token.KW_INTEGER;
import static com.alibaba.cobar.parser.recognizer.Token.KW_LIKE;
import static com.alibaba.cobar.parser.recognizer.Token.KW_NOT;
import static com.alibaba.cobar.parser.recognizer.Token.KW_SELECT;
import static com.alibaba.cobar.parser.recognizer.Token.KW_SEPARATOR;
import static com.alibaba.cobar.parser.recognizer.Token.KW_THEN;
import static com.alibaba.cobar.parser.recognizer.Token.KW_USING;
import static com.alibaba.cobar.parser.recognizer.Token.KW_WHEN;
import static com.alibaba.cobar.parser.recognizer.Token.KW_WITH;
import static com.alibaba.cobar.parser.recognizer.Token.LITERAL_CHARS;
import static com.alibaba.cobar.parser.recognizer.Token.OP_ASSIGN;
import static com.alibaba.cobar.parser.recognizer.Token.PUNC_COMMA;
import static com.alibaba.cobar.parser.recognizer.Token.PUNC_DOT;
...
import static com.alibaba.cobar.parser.recognizer.Token.USR_VAR;
...
public class SQLExprParser extends SQLParser {
    public SQLExprParser(SQLLexer lexer) {
        this(lexer, FunctionManager.INSTANCE_MYSQL_DEFAULT, true, DEFAULT_CHARSET);
    }

    public SQLExprParser(SQLLexer lexer, String charset) {
        this(lexer, FunctionManager.INSTANCE_MYSQL_DEFAULT, true, charset);
    }

    public SQLExprParser(SQLLexer lexer, FunctionManager functionManager, boolean cacheEvalRst, String charset) {
    ...
    private DMLSelectParser selectParser;

    public void setSelectParser(DMLSelectParser selectParser) {
    ...
    private Expression logicalOrExpression() throws SQLSyntaxErrorException {
        for (Expression expr = logicalXORExpression();;) {
            ...
            case KW_OR:
                ...
                expr = new LogicalOrExpression(expr, newExpr).setCacheEvalRst(cacheEvalRst);
                break;
            default:
                return expr;
            }
    ...
    private Expression logicalAndExpression() throws SQLSyntaxErrorException {
        for (Expression expr = logicalNotExpression();;) {
            ...
            case KW_AND:
                ...
                expr = new LogicalAndExpression(expr, newExpr).setCacheEvalRst(cacheEvalRst);
                break;
            default:
                return expr;
            }
    ...
    private QueryExpression subQuery() throws SQLSyntaxErrorException {
        if (selectParser == null) {
            selectParser = new DMLSelectParser(lexer, this);
        }
