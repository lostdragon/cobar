...
import static com.alibaba.cobar.parser.recognizer.Token.KW_CHARACTER;
import static com.alibaba.cobar.parser.recognizer.Token.KW_COLLATE;
import static com.alibaba.cobar.parser.recognizer.Token.KW_DEFAULT;
import static com.alibaba.cobar.parser.recognizer.Token.KW_DESC;
import static com.alibaba.cobar.parser.recognizer.Token.KW_DESCRIBE;
import static com.alibaba.cobar.parser.recognizer.Token.KW_FOR;
...
import static com.alibaba.cobar.parser.recognizer.Token.KW_LIMIT;
import static com.alibaba.cobar.parser.recognizer.Token.KW_OPTION;
import static com.alibaba.cobar.parser.recognizer.Token.KW_READ;
import static com.alibaba.cobar.parser.recognizer.Token.KW_SET;
import static com.alibaba.cobar.parser.recognizer.Token.KW_SHOW;
import static com.alibaba.cobar.parser.recognizer.Token.KW_WHERE;
import static com.alibaba.cobar.parser.recognizer.Token.OP_ASSIGN;
import static com.alibaba.cobar.parser.recognizer.Token.OP_ASTERISK;
import static com.alibaba.cobar.parser.recognizer.Token.OP_EQUALS;
...
public class DALParser extends SQLParser {
    ...
    public DALParser(SQLLexer lexer, SQLExprParser exprParser) {
        super(lexer);
