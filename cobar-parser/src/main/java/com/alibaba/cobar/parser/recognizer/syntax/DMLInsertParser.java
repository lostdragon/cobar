...
import static com.alibaba.cobar.parser.recognizer.Token.KW_INSERT;
import static com.alibaba.cobar.parser.recognizer.Token.KW_INTO;
import static com.alibaba.cobar.parser.recognizer.Token.KW_KEY;
 ...
 */
public class DMLInsertParser extends DMLInsertReplaceParser {
    public DMLInsertParser(SQLLexer lexer, SQLExprParser exprParser) {
