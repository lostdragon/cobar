...
import static com.alibaba.cobar.parser.recognizer.Token.KW_HAVING;
...
import static com.alibaba.cobar.parser.recognizer.Token.KW_UPDATE;
 ...
 */
public class DMLSelectParser extends DMLParser {
    public DMLSelectParser(SQLLexer lexer, SQLExprParser exprParser) {
    ...
    /**
     * first token is either {@link Token#KW_SELECT} or
     * {@link Token#PUNC_LEFT_PAREN} which has been scanned but not yet consumed
     * 
