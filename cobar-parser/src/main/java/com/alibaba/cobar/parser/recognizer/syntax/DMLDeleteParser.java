...
import static com.alibaba.cobar.parser.recognizer.Token.KW_DELETE;
 ...
 */
public class DMLDeleteParser extends DMLParser {
    public DMLDeleteParser(SQLLexer lexer, SQLExprParser exprParser) {
    ...
    /**
     * first token is {@link Token#KW_DELETE} <code><pre>
