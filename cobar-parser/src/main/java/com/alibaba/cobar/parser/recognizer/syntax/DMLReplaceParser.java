...
import static com.alibaba.cobar.parser.recognizer.Token.KW_REPLACE;
 ...
 */
public class DMLReplaceParser extends DMLInsertReplaceParser {
    public DMLReplaceParser(SQLLexer lexer, SQLExprParser exprParser) {
