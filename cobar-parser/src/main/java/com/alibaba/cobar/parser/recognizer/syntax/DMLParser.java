...
import static com.alibaba.cobar.parser.recognizer.Token.KW_GROUP;
import static com.alibaba.cobar.parser.recognizer.Token.KW_JOIN;
import static com.alibaba.cobar.parser.recognizer.Token.KW_ORDER;
import static com.alibaba.cobar.parser.recognizer.Token.KW_OUTER;
import static com.alibaba.cobar.parser.recognizer.Token.KW_UNION;
 ...
 */
public abstract class DMLParser extends SQLParser {
    protected SQLExprParser exprParser;

    public DMLParser(SQLLexer lexer, SQLExprParser exprParser) {
        super(lexer);
    ...
    /**
     * first token is {@link Token#KW_SELECT SELECT} which has been scanned but
     * not yet consumed
     */
    public DMLSelectStatement select() throws SQLSyntaxErrorException {
        return new DMLSelectParser(lexer, exprParser).select();
    }
