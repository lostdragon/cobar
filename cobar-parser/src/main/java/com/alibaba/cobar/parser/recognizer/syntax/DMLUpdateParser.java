...
import static com.alibaba.cobar.parser.recognizer.Token.KW_LOW_PRIORITY;
 ...
 */
public class DMLUpdateParser extends DMLParser {
    public DMLUpdateParser(SQLLexer lexer, SQLExprParser exprParser) {
