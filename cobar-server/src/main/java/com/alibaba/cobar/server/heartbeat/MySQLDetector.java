 ...
 * @author xianmao.hexm
 */
public final class MySQLDetector extends BackendConnection {
    ...
    public MySQLDetector(SocketChannel channel) {
        ...
        this.handler = new MySQLDetectorAuth(this);
    ...
    public void heartbeat() {
        if (isAuthenticated) {
            String sql = heartbeat.getSource().getNode().getConfig().getHeartbeat();
            if (sql != null) {
